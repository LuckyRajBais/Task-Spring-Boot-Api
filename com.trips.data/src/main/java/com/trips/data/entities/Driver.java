...
public class Driver {
	...
	public String toString() {
		return "Driver [startTime=" + startTime + ", endTime=" + endTime + ", vehicleName=" + vehicleName
				+ ", driverFirstName=" + driverFirstName + ", driverLastName=" + driverLastName + ", driverFullName="
				+ driverFullName + ", tripId=" + tripId + ", deviceId=" + deviceId + ", driverId=" + driverId
				+ ", vehicleId=" + vehicleId + ", distance=" + distance + ", duration=" + duration + ", maxStreetlimit="
				+ maxStreetlimit + ", maxSpeed=" + maxSpeed + ", city=" + city + "]";
	}
